    ...
    <Layout childrenClasses="pt-0 pb-0">
      <div className="blog-page-wrapper w-full bg-white">
        ...
        <div className="content-area w-full ">
          <div className="container-x mx-auto pb-[80px]">
            <div className="blog-article lg:flex lg:space-x-[30px] pb-7 ">
                    ...
                    <div className="w-full sm:flex justify-between items-center mb-8">
                      <div className="tags flex space-x-5 items-center">
                        ...
                        <div className="flex space-x-2.5 items-center">
                          ...
                          >
                            <span className="text-base cursor-pointer text-qpurple ">
                              <svg
                                width="35"
                                height="35"
                                viewBox="0 0 35 35"
              ...
              <div className="lg:w-[370px] w-full">
                ...
                >
                  ...
                  <div className="w-full h-[1px] bg-qpurplelow/10 mb-5"></div>
                  <div className="w-full h-[60px] rounded overflow-hidden relative">
                    ...
                    />
                    <span className="absolute right-5 top-[17px] text-qpurple">
                      <svg
                        width="25"
                        height="25"
                        viewBox="0 0 25 25"
                          ...
                          <div className="flex-1 h-full flex flex-col justify-between">
                            ...
                            >
                              <a rel="noopener noreferrer">
                                <h3 className="text-[18px] font-medium text-qblack leading-7 cursor-pointer mb-3">
                                  {post.blog.title}
                                </h3>
                              </a>
                            </Link>
                    ...
                    {details.categories.length > 0 &&
                      details.categories.map((category) => (
                        ...
                        >
                          ...
                          >
                            <a>
                              <span className="text-base text-qgray group-hover:text-qpurple cursor-pointer">
                                {category.name}
                              </span>
                            </a>
                          </Link>
