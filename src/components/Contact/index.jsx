...
export default function Contact({ datas }) {
  ...
  return (
    <Layout childrenClasses="pt-0 pb-0">
      ...
      <div className="contact-wrapper w-full bg-white pt-10 pb-[120px]">
            ...
            <div className="lg:w-1/2 w-full">
              {datas.contact && (
                <div>
                  ...
                  <div className="flex xl:flex-row flex-col xl:space-x-[30px] xl:space-y-0 space-y-[30px] mb-[30px]">
                    <div className="xl:w-1/2 w-full rounded  h-[196px] flex flex-col item justify-center bg-white border border-qpurple p-5">
                      ...
                      <p className="text-[22px] text-qblack leading-[30px] text-center font-semibold capitalize">
                        {langCntnt && langCntnt.phone}
                      </p>
                      <p className="text-[15px] text-qblack leading-[30px] text-center">
                        {datas.contact.phone}
                      </p>
                    </div>
                    <div className="xl:w-1/2 w-full rounded h-[196px] flex flex-col item justify-center bg-white border border-qpurple p-5">
                      ...
                      <p className="text-[22px] text-qblack leading-[30px] text-center font-semibold">
                  ...
                  <div className="p-5 flex flex-col justify-between w-full rounded bg-qpurplelow/10">
