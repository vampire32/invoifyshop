          ...
          if (res.data) {
            ...
            if (res.data.address) {
              ...
              if (
                ...
                parseInt(res.data.address.type) === 1
              ) {
                setHome(true);
              } else if (
                res.data.address.type === "office" ||
                parseInt(res.data.address.type) === 0
              ) {
                setOffice(true);
              } else {
                return false;
          ...
          <div className="form-area">
            <form>
              ...
              <div className="mb-6">
                ...
                <div
                  className={`w-full h-[50px] border px-5 flex justify-between items-center rounded border-qpurplelow/10 mb-2 ${
              ...
              {editAdd ? (
                ...
                <button
                  ...
                  className="w-full h-[50px]"
                >
                  <div className="transition-common h-full flex justify-center items-center bg-qpurple hover:bg-qpurplelow/10 hover:text-qpurple text-white  rounded">
